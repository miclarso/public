...
Version 12: Adds generic --env-var / -e flag to pass arbitrary runtime environment variables explicitly during deployment.
Version 11: Adds --endpoint-url flag to pass configuration parameters (e.g. quote of the day server endpoint) during deployment.
